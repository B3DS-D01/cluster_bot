...
n_similar_val=0
faqs = {}
with open('C:/Users/krish/Desktop/Data Science/b3ds/reBOT-master/ipfile.txt') as f:
    for line in f:
        ln=line.split(':')
...
def run():
    data = list(faqs.keys())
    with open('C:/Users/krish/Desktop/Data Science/b3ds/reBOT-master/faq_feats.pk1', 'rb') as f:
...
f=open('C:/Users/krish/Desktop/Data Science/b3ds/cluster_bot/text_file.txt','r',errors = 'ignore')
raw=f.read()
raw=raw.lower()
    ...
    if(FAQ_OUT != "Sorry, I'm not sure how to respond. Let me find someone who can help you."):
        ...
        if predicted_cluster == 0:
                ...
                if(req_tfidf==0):
                    ...
                    print(Faq_add)
                    # print(d['MESSAGE'])
                    y=open('C:/Users/krish/Desktop/Data Science/b3ds/cluster_bot/FAQ_UPD.txt','w')
                    y.write(Faq_add)
                    y.close()
